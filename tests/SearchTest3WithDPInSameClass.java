...
public class SearchTest3WithDPInSameClass
{
	...
	@Test(priority=1, dataProvider="googletestdata")
	public void googleHomePageTitleTest(String bn,String word) throws Exception
	{
		sa=new SoftAssert();
